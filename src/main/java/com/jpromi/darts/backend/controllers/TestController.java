...
public class TestController {
    ...
    public String test() {
        List<DartThrow> dartThrows = List.of(
                new DartThrow(null, null, ThrowMultiplier.TRIPLE, ThrowType.THROW, 20, 1500, 1, false, LocalDateTime.now()),
                new DartThrow(null, null, ThrowMultiplier.TRIPLE, ThrowType.THROW, 20, 1200, 1, false, LocalDateTime.now()),
                new DartThrow(null, null, ThrowMultiplier.TRIPLE, ThrowType.THROW, 20, 1800, 1, false, LocalDateTime.now())
        );
